...
// Factores K configurables para gatos
// NOTA: Estos valores son configurables y pueden ajustarse según referencias específicas
export const CAT_FACTORS: Record<ActivityLevel, number> = {
  inactive: 99,
  active: 132,
  veryActive: 160,
};

export function calculateCatRED({
  pvKg,
  activityLevel,
  adjustmentMode,
  adjustmentPct,
  ...
  const k = CAT_FACTORS[activityLevel];
