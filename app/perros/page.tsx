...
import { calculateDogRED, DOG_FACTORS } from '@/lib/calc/dog';
...
export default function PerrosPage() {
  ...
  const [result, setResult] = useState<ReturnType<typeof calculateDogRED> | null>(null);
  ...
  const handleCalculate = () => {
    ...
    try {
      const calculatedResult = calculateDogRED({
        pvKg: weight,
        activityLevel,
        adjustmentMode,
        adjustmentPct,
    ...
    <main className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-2">
            Calculadora RED - Perros
          </h1>
          <p className="text-lg text-gray-600">
            Calcula los Requerimientos de Energía Diarios para perros
          </p>
        </div>
